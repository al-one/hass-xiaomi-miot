...
TRANSLATION_LANGUAGES = {
    ...
    'uk': {
        ...
        'pause': 'Призупинено',
        'fault': 'Несправність',
        'Charge-Full': 'Повністю заряджено',
        ...
        'airer': {
            'airer': 'сушарка для білизни',
            'dryer': 'сушіння',
            'drying_level': 'рівень сушіння',
            'left_time': 'час, що залишився',
            'fault': 'несправність',
        },
        'airer.dryer': {
            'air drying': 'сушіння повітрям',
            'hot air drying': 'сушіння гарячим повітрям',
        },
        'airer.fault': {
            'no faults': 'несправностей немає',
            'obstruction': 'перешкода',
            'overweight': 'перевищення ваги',
            'overheat': 'перегрів',
            'motor failure': 'несправність двигуна',
        },

        'air_fresh.mode': {
            'auto': 'автоматичний',
            'interval': 'періодичний',
            'smart': 'розумний',
            'silent': 'тихий',
            'strong': 'потужний',
            'none': 'ручний',
        ...
        'dishwasher': {
            'dishwasher status': 'стан посудомийної машини',
            'dishwasher switch status': 'живлення посудомийної машини',
            'dishwasher mode': 'режим миття',
            'start wash': 'почати миття',
            'stop washing': 'зупинити миття',
            'dishwasher left time': 'час миття, що залишився',
        },
        'dishwasher.mode': {
            'basic': 'звичайне миття',
            'disinfecting': 'дезінфекція',
            'energy saving': 'енергоощадне миття',
            'glass': 'скло',
            'intensive': 'інтенсивне миття',
            'quick wash': 'швидке миття',
        },
        'dishwasher.status': {
            'busy': 'працює',
            'completed': 'миття завершено',
            'delay': 'відкладений запуск',
            'idle': 'очікування',
            'off': 'вимкнено',
            'paused': 'призупинено',
        ...
        'door_state': {
            'open': 'відкрита',
            'close': 'закрита',
            'close_timeout': 'не зачинено вчасно',
            'knock': 'стукіт',
            'breaking': 'спроба зламування',
            'stuck': 'двері застрягли',
        },

        'environment': {
            'environment air quality': 'якість повітря',
            'environment temperature': 'температура',
            'environment relative humidity': 'відносна вологість',
            'environment pm2.5 density': 'концентрація PM2.5',
            'environment co2 density': 'концентрація CO2',
            'environment tvoc density': 'концентрація ЛОС',
        },

        'filter': {
            'filter left time': 'залишковий час роботи фільтра',
            'filter used time': 'час використання фільтра',
            'filter life level': 'залишковий ресурс фільтра',
        },

        'fan.mode': {
            'basic': 'звичайний',
            'basic wind': 'звичайний потік',
            'straight wind': 'прямий потік',
            'natural wind': 'природний потік',
        ...
        'intelligent_speaker': {
            'wake up': 'активувати',
            'play music': 'відтворити музику',
            'play radio': 'увімкнути радіо',
            'play text': 'озвучити текст',
            'execute text directive': 'виконати текстову команду',
        },
        ...
        'lock_method': {
            'bluetooth': 'Bluetooth',
            'password': 'пароль',
            'biological': 'біометрія',
            'key': 'ключ',
            'turntable': 'поворотна ручка',
            'nfc': 'NFC',
            'one_time_password': 'одноразовий пароль',
            'two_step_verification': 'двоетапна перевірка',
            'coercion': 'розблокування під примусом',
            'homekit': 'HomeKit',
            'manual': 'ручний',
        ...
        'magnet_sensor': {
            ...
            'magnet sensor illumination': 'освітленість',
        },

        'motion_sensor': {
            'motion sensor': 'датчик руху',
            'motion sensor illumination': 'освітленість',
        },

        'occupancy_sensor': {
            'occupancy sensor occupancy status': 'стан присутності',
        },
        'occupancy_sensor.occupancy_status': {
            'no one exists': 'нікого немає',
            'someone exists': 'присутність виявлено',
        },
        ...
        'power_consumption': {
            'power consumption': 'споживання електроенергії',
            'power consumption electric power': 'потужність',
            'power consumption electric current': 'сила струму',
            'power consumption electric voltage': 'напруга',
            'power consumption voltage': 'напруга',
        },
        ...
        'temperature_humidity_sensor': {
            'temperature humidity sensor temperature': 'температура',
            'temperature humidity sensor relative humidity': 'відносна вологість',
            'temperature humidity sensor atmospheric pressure': 'атмосферний тиск',
        },
        ...
        'vacuum.sweep_mop_type': {
            'mop': 'вологе прибирання',
            'sweep': 'сухе прибирання',
            'sweep before mopping': 'спочатку сухе, потім вологе прибирання',
            'sweep mop': 'сухе та вологе прибирання',
        },
        'vacuum.sweep_type': {
            'Global': 'Глобальна',
            'Mop': 'Волога',
        ...
        'viomi_vacuum': {
            ...
            '2挡': 'рівень 2',
            '3挡': 'рівень 3',
            'dust-collection': 'збирання пилу',
            'door-state': 'стан контейнера для пилу',
            '出水量大小': 'подача води на швабру',
            '边刷剩余寿命百分比': 'ресурс бічної щітки',
            '边刷剩余寿命小时': 'залишковий час роботи бічної щітки',
            '主刷剩余寿命百分比': 'ресурс основної щітки',
            '主刷剩余寿命小时': 'залишковий час роботи основної щітки',
            '拖布剩余寿命百分比': 'ресурс швабри',
            '拖布剩余寿命小时': 'залишковий час роботи швабри',
            'hypa_hours': 'залишковий час роботи фільтра контейнера',
            'hypa_life': 'ресурс фільтра контейнера',
            '清扫使用时间，单位秒': 'тривалість прибирання',
            '清扫总面积，单位m2': 'прибрана площа',
            '清扫开始时间，时间戳，单位秒': 'час початку прибирання',
            'Y字形': 'Y-подібний маршрут',
            '弓字形': 'S-подібний маршрут',
        },

        'washer': {
            'drying level': 'рівень сушіння',
            'drying time': 'тривалість сушіння',
            'high water switch': 'високий рівень води',
            'rinsh times': 'кількість полоскань',
            'shake time': 'тривалість розпушування',
            'sleep mode': 'нічний режим',
            'soak time': 'тривалість замочування',
            'spin speed': 'швидкість віджиму',
            'start wash': 'почати прання',
            'status': 'стан роботи',
            'steam sterilization': 'стерилізація парою',
            'target temperature': 'температура прання',
            'target water level': 'цільовий рівень води',
        },
        'washer.mode': {
            'aromatherapy wash': 'ароматизоване прання',
            'baby care': 'піклування про дитину',
            'bacteria mite removal': 'видалення бактерій і кліщів',
            'boiling': 'кипіння',
            ...
            'heavy wash': 'прання сильно забруднених речей',
            'intensive': 'інтенсивне прання',
            'jacket': 'куртка',
            'jeans': 'джинси',
            'mite removal': 'видалення кліщів',
            'mix': 'змішані тканини',
            'new clothes wash': 'новий одяг',
            'pleased wash dry': 'прання та сушіння',
            'quick wash dry': 'швидке прання та сушіння',
            'quick wash': 'швидке прання',
            'rinse spin': 'полоскання та віджим',
            'rinse': 'полоскання',
            'shirt': 'сорочка',
            'silk': 'шовк',
            'smart': 'розумне прання',
            'soak wash': 'прання із замочуванням',
            'sock': 'шкарпетки',
            'spin': 'віджим',
            'sportswear': 'спортивний одяг',
            'super quick': 'надшвидке прання',
            'synthetic': 'синтетика',
            'towel': 'рушники',
            'underwear': 'нижня білизна',
            'user define': 'Користувацький',
            'wash dry': 'прання та сушіння',
            'wool': 'вовна',
        },
        'washer.drying_level': {
            'moist': 'злегка вологе',
            ...
            'extra': 'посилене',
            'none': 'без сушіння',
            'smart': 'розумне сушіння',
            'timed': 'сушіння за таймером',
        },
        ...
        'water_heater.mode': {
            'low': 'низька температура',
            'medium': 'середня температура',
            'high': 'висока температура',
        },
    },
