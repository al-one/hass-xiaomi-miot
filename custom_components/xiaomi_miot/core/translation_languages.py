...
TRANSLATION_LANGUAGES = {
    ...
    'de': {
        ...
        'physical_control_locked': {
            'physical control locked': 'physikalische Sperre',
        },
        ...
        'vacuum': {
            'robot cleaner': 'Saugerroboter',
            'robot cleaner status': 'Saugroboter-Status',
        },
        ...
        'viomi_vacuum': {
            ...
            '2挡': 'Level 2',
            '3挡': 'Level 3',
            'dust-collection': 'Staubsammlung',
            'door-state': 'Status Staubbehälter',
            '出水量大小': 'Wischwasservolumen',
            '边刷剩余寿命百分比': 'Lebensdauer der Seitenbürste',
            '边刷剩余寿命小时': 'Seitenbürste Stunden verbl.',
            '主刷剩余寿命百分比': 'Lebensdauer Hauptbürste',
            '主刷剩余寿命小时': 'Hauptbürste Stunden verbl.',
            '拖布剩余寿命百分比': 'Lebensdauer Mop',
            '拖布剩余寿命小时': 'Stunden verbl. Mop',
            'hypa_hours': 'Staubfilter Stunden verbl.',
            'hypa_life': 'Lebensdauer des Staubfilters',
            '清扫使用时间，单位秒': 'Renigungszeit',
            '清扫总面积，单位m2': 'Gereinigter Bereich',
            '清扫开始时间，时间戳，单位秒': 'Startzeit der Renigung (timestamp, in Sekunden)',
            'Y字形': 'Y-geformt',
            '弓字形': 'S-geformt',
        },
