...
TRANSLATION_LANGUAGES = {
    ...
    'pt': {
        ...
        'battery': {
            ...
            'battery charging state': 'Estado de carregamento',
        },
        ...
        'viomi_vacuum': {
            ...
            '2挡': 'Nível 2',
            '3挡': 'Nível 3',
            'dust-collection': 'Recolha de pó',
            'door-state': 'Estado do depósito',
            '出水量大小': 'Volume de água da mopa',
            '边刷剩余寿命百分比': 'Vida útil da escova lateral',
            '边刷剩余寿命小时': 'Horas da escova lateral',
            '主刷剩余寿命百分比': 'Vida útil da escova principal',
            '主刷剩余寿命小时': 'Horas da escova principal',
            '拖布剩余寿命百分比': 'Vida útil do pano',
            '拖布剩余寿命小时': 'Horas do pano',
            'hypa_hours': 'Horas do filtro HEPA',
            'hypa_life': 'Vida útil do filtro HEPA',
            '清扫使用时间，单位秒': 'Tempo de limpeza',
            '清扫总面积，单位m2': 'Área limpa',
            '清扫开始时间，时间戳，单位秒': 'Hora de início da limpeza',
            'Y字形': 'Em Y',
            '弓字形': 'Em S',
            '扫地机': 'Robô Aspirador',
        },
