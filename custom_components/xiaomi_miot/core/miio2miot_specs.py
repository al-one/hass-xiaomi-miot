...
MIIO_TO_MIOT_SPECS = {
    ...
    'xiaomi.aircondition.ma2': {
        ...
        'miio_specs': {
            ...
            'prop.2.4': {'prop': 'energysave', 
                'setter': 'set_energysave', 
                'template': '{{ value != 0 }}',
                'set_template': '{{ [value|int(1)] }}',
            },
            'prop.2.5': {'prop': 'auxheat', 
            'setter': 'set_auxheat',
            'template': '{{ value != 0 }}',
            'set_template': '{{ [value|int(1)] }}',
            },
            ...
            'prop.3.1': {'prop': 'wind_level', 'setter': 'set_wind_level', 'dict': {
                0: 0, #auto
                1: 1,
                2: 2,
                3: 3,
    ...
    'xiaomi.aircondition.ma4': 'xiaomi.aircondition.ma2',
    'xiaomi.aircondition.ma6': 'xiaomi.aircondition.ma2',
